...
// FirewallRule represents a firewalld rule entry
...
// FirewallStatus represents firewalld status and current rules
...
// PerformUpdateRequest is the request for updating LiteCP
