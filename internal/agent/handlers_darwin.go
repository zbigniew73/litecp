...
const (
	...
	caddyConfig      = "/usr/local/etc/litecp/Caddyfile"
...
$docRoot = '%s';
$logoPath = '';
$logoCandidates = ['/.litecp/logo-litecp.png', '/.litecp/logo.svg', '/.litecp/logo-small.png', '/.litecp/icon.png'];
...
<body>
    <main class="shell">
        <?php if ($logoPath !== ''): ?>
        <div class="brand">
            <img src="<?php echo htmlspecialchars($logoPath, ENT_QUOTES, 'UTF-8'); ?>" alt="LiteCP logo">
        </div>
        <?php endif; ?>
...
func copyDefaultSiteLogo(publicDir string) error {
	...
	fallback := `<svg xmlns="http://www.w3.org/2000/svg" width="420" height="90" viewBox="0 0 420 90" fill="none"><text x="50%" y="56%" text-anchor="middle" dominant-baseline="middle" font-family="Inter, Arial, sans-serif" font-size="44" font-weight="700" fill="#004AAD">LiteCP</text></svg>`
...
func (s *Server) handleSystemStatus(ctx context.Context, params json.RawMessage) (any, error) {
	...
	// LiteCP default PHP is 8.4. Prefer reporting that when installed.
	phpVersion := ""
...
func (s *Server) handleSystemServices(ctx context.Context, params json.RawMessage) (any, error) {
	...
	return []*ServiceStatus{
		{Name: "litecp", Status: "running", Enabled: true},
		{Name: "litecp-agent", Status: "running", Enabled: true},
...
func (s *Server) handleInstallFirewall(ctx context.Context, params json.RawMessage) (any, error) {
	return nil, fmt.Errorf("firewalld management is not supported on macOS - use Ubuntu for production")
}
